...
def get_entity(entity_id: str, graph_path: str):
    """Get entity by ID."""
    entities, _ = load_graph(graph_path)
    return entities.get(entity_id)


def query_entities(type_name: str, where: dict, graph_path: str):
...
def list_entities(type_name: str, graph_path: str):
...
def update_entity(entity_id: str, properties: dict, graph_path: str):
