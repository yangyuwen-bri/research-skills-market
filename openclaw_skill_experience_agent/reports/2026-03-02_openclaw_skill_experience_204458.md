...
- Probe `skills_cli_find`
  - 命令：`npx --yes skills find "自动化 测试" | head -n 20`
  - 退出码：0（耗时 10.9s）
  - 可选项：否
  - 输出片段：
    ```
...
[38;5;145mpatricio0312rev/skills@multi-tenant-safety-checker[0m [36m47 installs[0m
[38;5;102m└ https://skills.sh/patricio0312rev/skills/multi-tenant-safety-checker[0m

[38;5;145mcityfish91159/maihouses@skill-marketplace[0m [36m16 installs[0m
[38;5;102m└ https://skills.sh/cityfish91159/maihouses/skill-marketplace[0m

[38;5;145mabcfed/claude-marketplace@jenkins-deploy[0m [36m14 installs[0m
[38;5;102m└ https://skills.sh/abcfed/claude-marketplace/jenkins-deploy[0m

[38;5;145med1s0nz/cyberstrikeai@security-automation[0m [36m13 installs[0m
    ```
...
- Probe `open_meteo_fallback`
  ...
  - 输出片段：
    ```
{"latitude":51.49349,"longitude":-0.13172913,"generationtime_ms":0.0782012939453125,"utc_offset_seconds":0,"timezone":"GMT","timezone_abbreviation":"GMT","elevation":1.0,"current_weather_units":{"time":"iso8601","interval":"seconds","temperature":"°C","windspeed":"km/h","winddirection":"%","is_day":"","weathercode":"wmo code"},"current_weather":{"time":"2026-03-02T12:30","interval":900,"temperature":13.9,"windspeed":14.4,"winddirection":188,"is_day":1,"weathercode":1}}
    ```
